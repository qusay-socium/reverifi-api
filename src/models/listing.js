...
class Listing extends BaseModel {
  static associate({
    ...
    this.hasMany(PurchaseOffer, { as: 'listingOffer', foreignKey: 'listingId' });
    this.hasMany(ClaimListingAddress, { as: 'claimedListing', foreignKey: 'listingId' });
  }
  ...
  static async getPageWithRelations(page, limit, order = 'DESC', userId = null) {
    const { User, UserInfo, Features, ListingType, PropertyType, Transactions } =
